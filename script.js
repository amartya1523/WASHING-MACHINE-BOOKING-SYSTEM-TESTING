...
function showUserDashboard() {
    ...
    // Add dashboard entry animation
    userDashboard.classList.add('dashboard-entry');
    setTimeout(() => {
        userDashboard.classList.remove('dashboard-entry');
    }, 1200);
...
async function handleBooking(e) {
    ...
    try {
        ...
        if (response.ok) {
            ...
            setTimeout(() => {
                bookingForm.classList.remove('booking-success');
            }, 1500);
